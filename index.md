...
1. Descarga el fichero [SEB.zip](https://mglfcn.github.io/ic/SEB.zip), ábrelo y ejecuta el acceso directo 'SEB' que está dentro (doble clic).  
   Si no puedes descargar el zip haz clic [aquí](https://mglfcn.github.io/ic/index2.md).
